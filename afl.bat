...
set _dr_run=!_dr_run! -target_method main
set _dr_run=!_dr_run! -target_module "%_mtee%"
set _dr_run=!_dr_run! -target_offset 0x00014EF0
...
set _instrumentation=!_instrumentation! -target_offset 0x00014EF0
set _instrumentation=!_instrumentation! -target_method main
set _instrumentation=!_instrumentation! -nargs 2
set _instrumentation=!_instrumentation! -fuzz_iterations 100
